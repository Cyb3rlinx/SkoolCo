...
/** Tarjeta social del sitio — usada por cualquier página localizada sin OG propio (home, footer pages, etc). */
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          <div style={{ fontSize: 76, fontWeight: 800, lineHeight: 1.1 }}>{t("siteTitle")}</div>
          <div style={{ fontSize: 34, opacity: 0.85, lineHeight: 1.3 }}>{t("siteSubtitle")}</div>
        </div>
